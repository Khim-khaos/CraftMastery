...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    protected final List<TextureAtlasSprite> listAnimatedSprites;
    protected final Map<String, TextureAtlasSprite> mapRegisteredSprites;
    protected final Map<String, TextureAtlasSprite> mapUploadedSprites;
    protected final String basePath;
    private final ITextureMapPopulator iconCreator;
    private int mipmapLevels;
    protected final TextureAtlasSprite missingImage;
    ...
    protected void initMissingImage()
    {
